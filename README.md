...
<strong>
	<p>
		This branch is an archive of the version of Solar Protocol that ran from roughly 2021 - summer 2024. It is being kept for future reference and for servers that may be running the old version. It is being depreciated and should not be installed on new devices. Updates to maintain compatability can be done manually or by pulling relevent files (typically only those with frontend changes) from the main branch with the code below<br>
	</p>
</strong>
