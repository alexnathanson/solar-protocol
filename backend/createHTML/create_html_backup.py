...
def make_index(_local_data, _data):
    ...
    if (_data["battery percentage"]) < 0.50:
        index_template_file = open("templates/index-small.html").read()
        print("Low res mode")
    else:
        base_template_file = open("templates/index-large.html").read()
        print("High res mode")
...
def make_index(_local_data, _data):
    ...
    if (_data["battery percentage"]) < 0.50:
        ...
        index_template_file = open("templates/index-large.html").read()
        print("High res mode")


    template = Environment(loader=FileSystemLoader("templates/")).from_string(index_template_file)
