...
<p>Possible values:
	<ul>
		...
		<li>If 'err' is returned it indicates a failed response, likely a timeout due to an offline server. The default timeout is 60 seconds, but the timeout for these server calls is 15 seconds.</li>
	</ul>
</p>
