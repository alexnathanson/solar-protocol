...
$rootDir = "/home/pi/solar-protocol";
$ccDir = "$rootDir/charge-controller/data/";
$scaleIt = false;
...
// Add debug mode
if ($_GET['DEBUG']) {
    $todayFile = "$rootDir/dev/data/tracerDataTest.csv";
}
...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    if (!array_key_exists("server", $_GET)) {
        ...
        * */
        ...
        //this should be removed now that we can query the poe
            ...
            } elseif ($_GET["networkInfo"] == "timestamp") {
                $output = [];
    ...
    } elseif (array_key_exists("server", $_GET)) {
        //getServerData();
        getServerCCData();
    }
}
