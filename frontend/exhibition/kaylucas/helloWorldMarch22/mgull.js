class mgull {
  constructor(_w, _YRot, _x, _y, _z) {
    ...
    this.wingColor = color(150); //0, 180, 220 
  ...
  display() {
    if (this.greyToggle != greyScale) {
      this.greyToggle = greyScale;
      if (greyScale) {
        this.headColor = color(229);
        this.bodyColor = color(72);
        this.wingColor = color(178);
        this.neckColor = color(55);
        this.feetColor = color(158);
        this.legColor = color(75);
        this.tailColor = color(213);
        this.beakColor = color(93);
      }
      if (!greyScale) {
        this.headColor = color(30, 30, 30); // 86, 86, 86
        this.bodyColor = color(255); // 200, 150,  170); 
  ...
  drawLeg(_rotOffset) {
    ...
    pop()
    translate(0, 22, 0); // right toe Center 15
    cylinder(3, 80);
    pop();
    push();
    rotateX(0.7);
    translate(0, 22, 0); // right toe Right  translate(0, 25, 0)
    cylinder(3, 50);
    pop();
    push();
    rotateX(-0.7);
