...
* run Python script runner on start up
	...
	* verify it works `sudo reboot`  	
* open the root crontab `sudo crontab -e` and add this line to run the viz script
	* `*/20 * * * * /usr/bin/python3 /home/pi/solar-protocol/backend/createHTML/viz.py >> /home/pip/solar-protocol/createHTML/viz.log`
