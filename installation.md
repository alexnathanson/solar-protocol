...
### Notes on Opening Up Ports
* Log into the router and set up a static internal IP
* Set up port forwarding for port 22 and 80 for the internal IP address
* In some cases, ISPs blocks ports. Call them to check these ports arent blocked.
