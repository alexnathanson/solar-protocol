...
sudo chmod +x /home/pi/solar-protocol/backend/*.py
sudo chmod +x /home/pi/solar-protocol/backend/createHTML/*.py
sudo chmod +x /home/pi/solar-protocol/backend/core/*.py
